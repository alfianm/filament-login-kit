...
namespace AlfianM\FilamentLoginKit\Compatibility\V5;
...
/**
 * Login page for Filament v5
 * Extends: Filament\Auth\Pages\Login
 */
class LoginPage extends Login
{
    protected string $view = 'filament-login-kit-v5::pages.login';
    ...
    protected function getPlugin(): LoginKitPlugin
    {
        ...
        $plugin = Filament::getCurrentOrDefaultPanel()->getPlugin('filament-login-kit');
        return $plugin;
    }
}
